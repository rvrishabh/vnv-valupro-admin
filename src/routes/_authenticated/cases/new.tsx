...
// Property location, tehsil and bank reference are captured in the valuation
// editor, so intake stays to the minimum needed to open the case.
const formSchema = createCasePayloadSchema;
